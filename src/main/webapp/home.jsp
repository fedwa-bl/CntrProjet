...
<body>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            <div class="top-info">
                              <nav class="main-menu mobile-menu">
                                <ul>
                                    <i style='font-size:25px;color:white' class='fas'>&#xf406;</i>
    ...
    <div class="hero-slider">
        <div class="slider-item">
            <div class="single-slider-item set-bg" data-setbg="assets2/img/slider-1.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                    ...
                    <div class="col-lg-6">
                        <div class="room-item">
                            <div class="room-pic-slider room-pic-item owl-carousel">
                                <div class="room-pic">
                                    <img src="assets2/img/room-slider/room-1.jpg" alt="">
                                </div>
                                <div class="room-pic">
                                    <img src="assets2/img/room-slider/room-2.jpg" alt="">
                                </div>
                                <div class="room-pic">
                                    <img src="assets2/img/room-slider/room-3.jpg" alt="">
                                </div>
                            </div>
                            <div class="room-text">
            ...
            <div class="facilities-content">
                <div class="row">
                    ...
                    <div class="col-lg-6 p-0">
                        <div class="facilities-img set-bg" data-setbg="assets2/img/facilities-1.jpg"></div>
                    </div>
                    <div class="col-lg-6 p-0 ">
                        ...
                        <ul class="nav" role="tablist">
                            <li>
                                <a data-toggle="tab" href="#testimonial-1" role="tab" class="show active">
                                    <div class="author-pic">
                                        <img src="assets2/img/testimonial/author-1.jpg" alt="">
                                    </div>
                            ...
                            <li>
                                <a data-toggle="tab" href="#testimonial-2" role="tab">
                                    <div class="author-pic">
                                        <img src="assets2/img/testimonial/author-2.jpg" alt="">
                                    </div>
                                    <div class="author-text">
                                        <h5>John Doe <span>Berlin</span></h5>
                                    </div>
                            ...
                            <li>
                                <a data-toggle="tab" href="#testimonial-3" role="tab">
                                    <div class="author-pic">
                                        <img src="assets2/img/testimonial/author-3.jpg" alt="">
                                    </div>
                                    <div class="author-text">
                                        <h5>John Doe <span>Berlin</span></h5>
                                    </div>
    ...
    <div class="footer-room-pic">
        <div class="container-fluid">
            <div class="row">
                <img src="assets2/img/room-footer-pic/room-1.jpg" alt="">
                <img src="assets2/img/room-footer-pic/room-2.jpg" alt="">
                <img src="assets2/img/room-footer-pic/room-3.jpg" alt="">
                <img src="assets2/img/room-footer-pic/room-4.jpg" alt="">
            </div>
        </div>
    </div>
