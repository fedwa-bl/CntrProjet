...
<body>
    ...
    <!-- Hero Section Begin -->
    <section class="hero-section set-bg" data-setbg="assets2/img/contact-bg.jpg">
        <div class="hero-text">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <img src="assets2/img/edit.png" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="input-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <img src="assets2/img/envelop-copy.png" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="input-group phone-num">
                                        <input type="text" placeholder="Phone">
                                        <img src="assets2/img/phone-copy.png" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                     <div class="input-group phone-num">
